...
**版本：v1.1.17（定稿，可施工）** ｜ 日期：2026-08-27

> 本文件為 v1.0 → v1.1 → v1.1.1 → v1.1.2 → v1.1.3 → v1.1.4 → v1.1.5 → v1.1.6 → v1.1.7 → v1.1.8 → v1.1.9 → v1.1.10 → v1.1.11 → v1.1.12 → v1.1.13 → v1.1.14 → v1.1.15 → v1.1.16 → v1.1.17 合併後的完整規格，單獨即可作為施工依據，無需回查舊版。
